...
function Settings:CreatePanel()
    ...
    arrowCheckbox:SetScript("OnClick", function(cb)
        AzerothPilotDB.showArrow = cb:GetChecked()
    ...
    autoAcceptCheckbox:SetScript("OnClick", function(cb)
        AzerothPilotDB.autoAccept = cb:GetChecked()
    end)
    ...
    autoTurnInCheckbox:SetScript("OnClick", function(cb)
        AzerothPilotDB.autoTurnIn = cb:GetChecked()
    end)
    ...
    soundCheckbox:SetScript("OnClick", function(cb)
        AzerothPilotDB.soundEnabled = cb:GetChecked()
    end)
